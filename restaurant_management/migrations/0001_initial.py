# Generated by Django 3.2.8 on 2021-11-07 04:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Ban',
            fields=[
                ('so_ban', models.CharField(db_column='SO_BAN', max_length=5, primary_key=True, serialize=False)),
                ('so_cho_ngoi', models.IntegerField(db_column='SO_CHO_NGOI')),
        ...
        migrations.CreateModel(
            name='HoaDon',
            fields=[
                ('ma_hoa_don', models.CharField(db_column='MA_HOA_DON', max_length=5, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='NhanVien',
            fields=[
                ('ma_nhan_vien', models.CharField(db_column='MA_NHAN_VIEN', max_length=5, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='DatBan',
            fields=[
                ('ma_khach_hang', models.OneToOneField(db_column='MA_KHACH_HANG', on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='restaurant_management.khachhang')),
